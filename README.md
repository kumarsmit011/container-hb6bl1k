...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hb6bl1k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hb6bl1k.containers.anotherwebservice.com/
...
```
git clone git@github.com:kumarsmit011/container-hb6bl1k.git
cd container-hb6bl1k
```
...
```
docker attach container-hb6bl1k
```
...
## Example: Moving Average Trading Strategy (Educational)

This repository includes `moving_average_strategy.py`, a small example that fetches historical price data using `yfinance` and applies a moving average crossover strategy. The script prints the last few rows of the calculated signals.
...
This example is provided for educational purposes only and is **not** financial advice.
